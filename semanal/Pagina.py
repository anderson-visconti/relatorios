    ...
    def cria(self):
        ...
        sec = html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    html.Br([]),
                    html.P(self.config.config_meteo['texto'][0], className='p'),

                    html.P(self.config.config_meteo['texto'][1], className='p'),
...
class Hidro(Secao):
    ...
    def cria(self):
        ...
        sec = html.Div([
            ...
            html.P(self.config.config_hidro['texto'][0], className='p'),

            html.P(self.config.config_hidro['texto'][1], className='p'),
...
class Arm(Secao):
    def cria(self):
        ...
        sec = html.Div([
            ...
            html.Br([]),
            html.P(self.config.config_arm['texto'][0], className='p'),
            html.P(self.config.config_arm['texto'][1], className='p'),
...
class Preco(Secao):
    def cria(self):
        ...
        sec = html.Div([
            html.Div([
                html.H6('Análise Preço', className='gs-header gs-text-header padded'),
                html.Br([]),
                html.P(self.config.config_preco['texto'][0], className='p'),
                html.P(self.config.config_preco['texto'][1], className='p'),
            ],
                className='row'
            ),
    ...
    def cria(self):
        ...
        sec = html.Div([
            html.Div([
                ...
                html.Br([]),
                html.P(self.config.config_forward['texto'][0], className='p'),
                html.P(self.config.config_forward['texto'][1], className='p'),
            ],
                className='twelve columns'
            ),
    ...
    def cria(self):
        ...
        sec = html.Div([
            ...
            html.Div([
                html.Div([
                    html.Br([]),
                    html.P(self.config.config_reg['texto'][0], className='p'),
                    html.P(self.config.config_reg['texto'][1], className='p'),
                ],
                    className='six columns'
                ),
